...
namespace Prototype.Data
{
    internal static class Util<U>
    {
        ...
        /// </summary>
        /// <typeparam name="T">The type to get the _collection of.</typeparam>
        /// <param name="connectionString">The connectionstring to use to get the _collection from.</param>
        ...
        /// </summary>
        /// <typeparam name="T">The type to get the _collection of.</typeparam>
        /// <param name="url">The url to use to get the _collection from.</param>
